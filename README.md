...
| **[qa-web-automation-playwright](https://github.com/ThiagoValmir/qa-web-automation-cypress)** | Projeto de automação de testes web utilizando Cypress para testes end-to-end, incluindo validações de interface, fluxos de usuário, assertions, fixtures e relatórios.      | 📅 Planejado    |
...
| **[qa-web-automation-playwright](https://github.com/ThiagoValmir/qa-web-automation-cypress)** | Web test automation project using Cypress for end-to-end testing, including UI validation, user flows, assertions, fixtures, and reporting.                                    | 📅 Planned     |
